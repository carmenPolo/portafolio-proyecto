...
function propiedades_post_type() {
	...
	$labels = array(
		...
		'add_new_item'          => __( 'Agregar nueva Propiedad', 'text_domain' ),
		'add_new'               => __( 'Agregar nueva', 'text_domain' ),
		'new_item'              => __( 'Agregar Propiedad', 'text_domain' ),
		...
		'not_found'             => __( 'No se encontraron Propiedades', 'text_domain' ),
...
add_action( 'init', 'propiedades_post_type', 0 );
?>
